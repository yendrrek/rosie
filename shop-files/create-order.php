...
class CreateOrder 
{
    ...
    {          
        $currency_code = 'GBP';
        /* Without formatting the price, for example 17.90 will be converted to 17.89999999, and PayPal SKD will throw an error. */
        ...
        if (!empty($_SESSION['basket'])) {
            foreach ($_SESSION['basket'] as $i => $product) {
                ...
                $productDetail['quantity'] = $product['productQty'];
